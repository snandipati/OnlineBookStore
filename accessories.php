...
$term = isset($_POST['term'])?$_POST['term']:null;
 ...
 where (p.productname like '%$term%' or p.productdescription like'%$term%' or c.categorytype like '%$term%' or m.manufacturername like '%$term%') and p.productid = p.productid and p.categoryid = 4 and p.categoryid = c.categoryid and p.manufacturerid = m.manufacturerid order by p.productid");
